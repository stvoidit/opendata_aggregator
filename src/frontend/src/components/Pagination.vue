...
const paginate = computed(() => {
    ...
    if (totalPages.value <= props.pagesShown) {
        ...
        const maxPagesShownBeforeCurrentPage = Math.floor(props.pagesShown / 2);
        const maxPagesShownAfterCurrentPage = Math.ceil(props.pagesShown / 2) - 1;
        ...
        <ul :class="bindPaginationClass">
            <li
                ...
                <a
                    class="page-link"
                    href="#"
                    @click.prevent="onChangePage(1)">{{ firstJumpContent }}</a>
            </li>
            <li
            ...
            <li
                ...
                <a
                    class="page-link"
                    href="#"
                    @click.prevent="onChangePage(totalPages)">{{ lastJumpContent }}</a>
            </li>
        </ul>
    </nav>
</template>
